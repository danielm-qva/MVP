...
@Component({
  selector: 'app-add-waste-process',
  templateUrl: './add-waste-process.component.html',
  styleUrls: ['./add-waste-process.component.css']
})
export class AddWasteProcessComponent implements OnInit {
...
ngOnInit(): void {
  ...
  onSubmit(){
    ...
    console.log(data);
      this.service.AddWProcess(data).subscribe(res => {
       this.toast.success("Operacion realizada con exito.." , 'Boot MVP');
       this.route.navigate(['/mambietal/listWasteProcess']);
      } , error => {
